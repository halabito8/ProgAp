...
void pedir(int *array,int *numero);
void ordenar(int *array,int *insertados,int numero);
void imprimir(int *array,int insertados);
...
int main(void){
  ...
  do{
    ...
    scanf("%i",&largo);
    if(largo>100)
      printf("Introdujiste un numeor mayor a 100.\n");
  }while(largo>100);
  for(i=0;i<largo;i++){
    pedir(array,&numero);
